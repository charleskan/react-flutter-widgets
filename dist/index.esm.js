...
class AlignmentGeometry {
    ...
    static lerp(a, b, t) {
        ...
        const resolvedA = a.resolve(TextDirection$1.ltr);
        const resolvedB = b.resolve(TextDirection$1.ltr);
...
class AlignmentDirectional extends AlignmentGeometry {
    ...
    resolve(direction) {
        if (direction === TextDirection$1.rtl) {
...
function Align({ alignment = Alignment$1.center, widthFactor, heightFactor, child, children, className, style, }) {
    ...
    const childWrapperStyles = useMemo(() => {
        const alignmentCSS = alignmentToCSS(alignment);
...
const ListViewBase = forwardRef(function ListView({ children = [], scrollDirection = Axis.VERTICAL, reverse = false, shrinkWrap = false, primary, physics = ScrollPhysics.DEFAULT, padding, itemExtent, prototypeItem, clipBehavior = 'visible', className, style, semanticChildCount, ...aria }, ref) {
    ...
    const containerClasses = useMemo(() => buildContainerClasses(scrollDirection, reverse, shrinkWrap, physics, clipBehavior, paddingClasses, className), [scrollDirection, reverse, shrinkWrap, physics, clipBehavior, paddingClasses, className]);
    return (jsxRuntimeExports.jsx("ul", { ref: elRef, className: containerClasses, style: style, "aria-orientation": scrollDirection === Axis.VERTICAL ? 'vertical' : 'horizontal', ...aria, "data-primary": primary ? 'true' : undefined, children: children?.map((child, i) => (jsxRuntimeExports.jsx(ItemWrap, { axis: scrollDirection, itemExtent: itemExtent, physics: physics, children: child }, child?.key ?? i))) }));
});
/**
...
function GestureDetector({ children, className, style, behavior = HitTestBehavior.deferToChild, excludeFromSemantics = false, ariaLabel, onTap, onTapDown, onTapUp, onTapCancel, onDoubleTap, onLongPress, onLongPressStart, onLongPressMoveUpdate, onLongPressEnd, onPanStart, onPanUpdate, onPanEnd, onScaleStart, onScaleUpdate, onScaleEnd, longPressDelay = 500, doubleTapDelay = 300, tapSlop = 10, panSlop = 10, longPressMoveTolerance = 6, }) {
    ...
    const getScaleRotate = useCallback((prev, curr) => {
