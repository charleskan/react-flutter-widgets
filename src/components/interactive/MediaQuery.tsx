...
export const defaultBreakpoints: MediaQueryBreakpoints = { xs: 0, sm: 576, md: 768, lg: 992, xl: 1200 };
...
export default function MediaQuery({ children, breakpoints = defaultBreakpoints, data }: MediaQueryProps) {
  ...
  const contextValue = useMemo<MediaQueryContextValue>(() => ({ ...mediaQueryData, breakpoints }), [mediaQueryData, breakpoints]);
