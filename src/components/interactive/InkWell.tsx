...
function InkWell(props: InkWellProps) {
  ...
  return (
    <div ref={containerRef} className={className} style={containerStyle} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} onClick={handleClick} onFocus={shouldBeAccessible ? handleFocus : undefined} onBlur={shouldBeAccessible ? handleBlur : undefined} onKeyDown={shouldBeAccessible ? handleKeyDown : undefined} onKeyUp={shouldBeAccessible ? handleKeyUp : undefined} role={excludeFromSemantics ? undefined : semanticRole} tabIndex={effectiveTabIndex} {...ariaAttributes}>
